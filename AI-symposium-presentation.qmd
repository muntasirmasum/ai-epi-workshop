...
**Four workflows:** Coding • Analysis • Plotting • Debugging

## AI-Assisted Analysis Workflow

::: {style="font-size: 1.5em; text-align: center; padding: 50px 40px; background: linear-gradient(135deg, #f8f5fc 0%, #e6dff5 50%, #f0edf7 100%); border-radius: 20px; box-shadow: 0 8px 16px rgba(70, 29, 124, 0.15);"}
<div style="display: flex; justify-content: space-around; align-items: center; flex-wrap: wrap; gap: 20px;">
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">📊</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Data Loading</div>
  </div>
  <div style="font-size: 2em; color: #9370DB;">→</div>
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">🔍</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Exploration</div>
  </div>
  <div style="font-size: 2em; color: #9370DB;">→</div>
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">🧹</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Cleaning</div>
  </div>
  <div style="font-size: 2em; color: #9370DB;">→</div>
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">📈</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Analysis</div>
  </div>
  <div style="font-size: 2em; color: #9370DB;">→</div>
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">📉</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Visualization</div>
  </div>
  <div style="font-size: 2em; color: #9370DB;">→</div>
  <div style="text-align: center;">
    <div style="font-size: 2.5em; color: #461D7C;">💡</div>
    <div style="color: #461D7C; font-weight: bold; margin-top: 10px;">Interpretation</div>
  </div>
</div>
:::
...
::: {.column width="10%"}
<div style="display: flex; align-items: center; justify-content: center; height: 100%; font-size: 3em; color: #461D7C;">⇄</div>
:::
...
::: {style="font-size: 0.9em; margin-top: 15px; padding: 15px; background-color: #fff3cd; border-radius: 5px;"}
**Teaching moment:** Claude uses Socratic questioning to help students think critically about statistical vs. clinical significance
:::
