...
::: {.column width="33%"}
::: {.card}
[**Context**]{.card-icon style="font-size: 1.6em;"}
...
::: {.column width="33%"}
::: {.card-orange}
[**Live Demo**]{.card-icon style="font-size: 1.6em;"}
...
::: {.column width="33%"}
::: {.card-blue}
[**Discussion**]{.card-icon style="font-size: 1.6em;"}
...
::: {.column width="25%"}
::: {.card}
[**Educators**]{style="font-size: 1.1em;"}
...
::: {.column width="25%"}
::: {.card}
[**Students**]{style="font-size: 1.1em;"}
...
::: {.column width="25%"}
::: {.card}
[**Researchers**]{style="font-size: 1.1em;"}
...
::: {style="text-align: center; margin-top: 30px; font-size: 0.85em;"}
...
Direct RStudio integration via Claude Desktop app

[*<span class="highlight-orange">Most accessible</span>*]{style="font-size: 0.85em;"}
:::
:::
...
Claude Desktop App + copy/paste to RStudio

[*<span class="highlight-orange">Intermediate approach</span>*]{style="font-size: 0.85em;"}
:::
:::
...
Full AI IDE integration with autonomous execution

[*<span class="highlight-orange">Most powerful</span>*]{style="font-size: 0.85em;"}
:::
:::
:::
...
::: {style="background-color: #f0f0f0; padding: 16px; border-radius: 10px; font-size: 0.7em;"}
...
## {.section-divider data-background-color="#461D7C"}

::: {style="text-align: center;"}
[Let's See It in Action]{style="color: white; font-family: 'Playfair Display', serif; font-size: 2em; font-weight: 900;"}
...
::: {.tip-box}
**R Tip:** `na.omit()` drops ALL rows with any NA — consider `filter(!is.na(var))` for targeted removal
:::
...
::: {style="text-align: center;"}
[Telling the Story with Data]{style="color: white; font-family: 'Playfair Display', serif; font-size: 2em; font-weight: 900;"}
...
::: {.claude-box}
**Claude suggests:** Scatter plot with regression lines, separate by sex, add confidence intervals, clear labels
:::
...
::: {.tip-box}
**ggplot Tip:** `alpha` controls transparency — essential when you have overlapping points (overplotting)
:::
...
::: {style="text-align: center;"}
[Bringing It All Together]{style="color: white; font-family: 'Playfair Display', serif; font-size: 2em; font-weight: 900;"}
...
2. Create Claude account at [claude.ai](https://claude.ai)
3. Install packages:
...
[github.com/muntasirmasum/ai-epi-workshop](https://github.com/muntasirmasum/ai-epi-workshop)
:::
:::
:::
