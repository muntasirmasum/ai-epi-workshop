...
<div class="student-ask" style="font-size: 0.7em; margin-bottom: 12px;">
🎓 Won't students just let AI do all the work?
</div>

<div class="card card--green" style="text-align: left; font-size: 0.58em; line-height: 1.5;">
<strong style="color: #461D7C;">Short answer: Not with Cowork.</strong><br><br>
Claude Cowork is a <em>tutor</em>, not an autopilot. Students still choose the variables, interpret the output, and explain the results. Claude explains <em>why</em> code works — it doesn't just hand over answers. The learning happens in the conversation, not the copy-paste.
</div>
...
<strong>Claude Chat:</strong> Free tier available at claude.ai<br>
<strong>ClaudeR + Cowork:</strong> Free (uses Claude Desktop App)<br>
<strong>Claude Code:</strong> Requires paid API (~$5–20/month typical use)<br><br>
