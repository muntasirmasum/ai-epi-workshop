...
<strong>4.</strong> Open <code>workshop-demo.R</code> and start running code!
</div>

. . .

<div class="tip-box" style="font-size: 0.72em;">
<strong>What's included:</strong> R + RStudio in the cloud, NHANES data, all packages pre-installed, the complete analysis script from today's demo, and challenges to try on your own.
</div>
