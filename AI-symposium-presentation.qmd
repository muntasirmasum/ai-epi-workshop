...
%%| fig-width: 14
flowchart TD
    A[👨‍🎓 Student asks question] --> B[🤖 Claude understands context]
    B --> C[💻 Claude generates R code]
    C --> D[📝 Student reviews & runs code]
    D --> E{Results<br/>correct?}
    E -->|No| F[🐛 Claude helps debug]
    F --> C
    E -->|Yes| G[💡 Claude explains output]
    G --> H[📊 Student interprets results]
    H --> I{More<br/>questions?}
    I -->|Yes| A
    I -->|No| J[✅ Analysis complete]
...
# Convert to interactive plot ← Claude adds: interactivity with plotly
