...
::: {style="font-size: 1.8em; text-align: center; padding: 40px; background: linear-gradient(to right, #f8f9fa, #e9ecef); border-radius: 15px;"}
<span style="color: #461D7C; font-weight: bold;">📊 Data Loading</span> →
<span style="color: #461D7C; font-weight: bold;">🔍 Exploration</span> →
<span style="color: #461D7C; font-weight: bold;">🧹 Cleaning</span> →
<span style="color: #461D7C; font-weight: bold;">📈 Analysis</span> →
<span style="color: #461D7C; font-weight: bold;">📉 Visualization</span> →
<span style="color: #461D7C; font-weight: bold;">💡 Interpretation</span>
:::
...
::: {.column width="10%"}
<div style="text-align: center; font-size: 3em; color: #461D7C; padding-top: 60px;">⇄</div>
:::
