...
<p>RStudio MCP connected to Claude Desktop App — Claude sees your environment</p>
...
ggplot(pred, aes(x = x, y = predicted, color = group, fill = group)) +
  ...
  scale_fill_manual(values = c("female" = "#D55E00", "male" = "#0072B2")) +
  labs(
    title = "Predicted Systolic Blood Pressure by Alcohol Consumption",
    subtitle = "Adjusted for Age, BMI, and Smoking | Shaded area = 95% CI",
    x = "Drinks Per Week",
